...
print("Running 2_Intermediate/boozerQH.py")
print("================================")
...
JF = J_nonQHRatio + J_iotas + J_major_radius + Jls
...
def fun(dofs):
    ...
    outstr = f"J={J:.1e}, J_nonQHRatio={J_nonQHRatio.J():.2e}, iota={boozer_surface.res['iota']:.2e}, mr={mr.J():.2e}"
